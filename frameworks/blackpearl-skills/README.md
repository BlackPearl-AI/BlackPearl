...
- **Master Hard Rules**: 5-Level Modular Decomposition and Documentation-First Sequential Execution.
- **MCP Configurations**: Shared MCP connectors for enhanced agent tooling.

---

## 📂 Architecture

- **`agents/`**: 68 specialized engineering subagents.
- **`skills/`**: 286+ workflow skills and domain cheatsheets.
- **`commands/`**: Slash command patterns and macros.
- **`rules/`**: Universal and language-specific engineering constraints.
- **`hooks/`**: Event-driven hooks and automated triggers.
